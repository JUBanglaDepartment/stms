                ...
                <div class="row">
                    <div class="col-md-3">
                        <ul class="list-unstyled profile-nav">
                            <li>
                                <img src="../assets/pages/media/profile/default.png" class="img-responsive pic-bordered" alt="" />
                            </li>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-8 profile-info">
                                <h1 class="font-green sbold uppercase"><?php echo $this->session->userdata('userName');?></h1>
                            ...
                            <div class="col-md-4">
                                <div class="portlet sale-summary">
                                    <div class="portlet-title">
                                        <div class="caption font-red sbold"> SMS Summary </div>
                                        <div class="tools">
                        ...
                        <div class="tabbable-line tabbable-custom-profile">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#tab_1_11" data-toggle="tab"> Active Account </a>
                                </li>
                                <li>
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-advance table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td class="hidden-xs">
                                                    <?php echo $credits['start_date'];?>
                                                </td>
                                                <td class="hidden-xs">
                                                    <?php echo $credits['end_date'];?>
                                                </td>

                                                <td>
                                                    <?php echo $credits['sms_credit'].' &nbsp TK';?>
                                                </td>
                                                <td>
                                                    <?php
                                                        if($credits['accStatus'])
                                                        {
                                                        echo $credits['remaining_credit'].' &nbsp TK';
                                                    ?>
                                                        <span class="label label-success label-sm"> Active Account </span>
                                                    <?php
                                                        }
                                                        else
                                                        {
                                                        echo $credits['remaining_credit'].' &nbsp TK &nbsp';
                                                       ?>
                                                        <span class="label label-warning label-sm"> Closed Account </span>
